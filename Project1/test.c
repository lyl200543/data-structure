...
//读字符：fgetc函数： int fgetc ( FILE * stream )  到达文件末尾返回EOF（-1）
//int main()
//{
//    //打开文件
...
//将字符串输出至文件时：1》不含有结尾标志'\0' 2》不自动添加换行符
// 
//int main()
//{
//    FILE* pf = fopen("test.txt", "w");
...
//应用：
//#include<stdio.h>  //文件操作相关的函数
//int main()
//{
//    char str[100];
//    int lines = 0;
//    FILE* pf = fopen("test.txt", "a+");  //a+代表以读和追加的形式打开
//    if (pf == NULL)
//    {
